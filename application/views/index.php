		...
		<div class="wrapper">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="intro-content-text">
								...
								<div class="exper">
									<div class="numb-ex">
										<span class="word" data-dsn-animate="text">35+</span>
									</div>

									<h4 data-dsn-animate="up">HAPPY CLIENTS</h4>
								</div>
			...
			<section class="our-work work-under-header  section-margin" data-dsn-col="3">
				<div class="container">
					<div class="one-title">
						...
						<h2 class="title-main">Making a mark, one day at a time!</h2>
					</div>
				</div>
				<div class="container-fluid">
					<div class="row">
			...
			<section class="our-news section-margin">
				<div class="container">
					<div class="one-title" data-dsn-animate="up">
						<div class="title-sub-container">
							<p class="title-sub">Latest Blog Posts</p>
						</div>
						<h2 class="title-main">Some valuable Infotainment</h2>
					</div>
