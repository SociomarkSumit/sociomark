...
class media_model extends CI_Model {
	...
	public function resize_thumb($filename){
		...
		$imagesource1=$_SERVER['DOCUMENT_ROOT'].'/images/media/'.$filename;
		$newimagesource1=$_SERVER['DOCUMENT_ROOT'].'/images/media/thumbs/'.$filename;
		// Configuration 
	...
	public function delete_file_method($dataId,$data_field1='no_field'){
		...
		if($this->db->update('media',$data)){
			unlink(WEBSITEPATH.'/images/media/'.$row->$data_field);
		}
